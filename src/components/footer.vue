<template>
    <section>
        <div class="container flex p-10 justify-center " >


            <footer class="text-center text-white" style="background-color: #f1f1f1;">
                <div class="container pt-9">
                    <div class="flex justify-center mb-9">
                        <a href="https://www.facebook.com/Sijoy5000" class="mr-9 text-gray-800">
                        ...
                        <a href="https://github.com/joy5000" class="text-gray-800">
